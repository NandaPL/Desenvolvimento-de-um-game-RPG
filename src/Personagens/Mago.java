...
public class Mago extends Personagem implements ComportamentoMagico {
    ...
    public void invisibilidade(){
        ...
        if(visivel) {
            ...
            JOptionPane.showMessageDialog(null,("O mago " + getNome() + " ficou invisível."));
        } else{
            System.out.println("O mago " + getNome() + " está visivel.");
            JOptionPane.showMessageDialog(null,("O mago " + getNome() + " está visivel."));
        }
    }
    ...
    public void ultraRapidez() {
        ...
        JOptionPane.showMessageDialog(null,("O mago " + getNome() + " usou a super velocidade."));
    }
    ...
    public void andar() {
        ...
        JOptionPane.showMessageDialog(null,("O mago " + getNome() + " andou " + passos + "."));
    }
    ...
    public void guardarItem() {
        ...
        JOptionPane.showMessageDialog(null,("O mago " + getNome() + " guardou o(a) " + item + "."));
    }
    ...
    public void usarItem() {
        ...
        JOptionPane.showMessageDialog(null,("O mago " + getNome() + " usou o(a) " + item + "."));
    }
}
